...
public class CubeRotationAnimation implements GLEventListener{
	...
	public static void main(String[] args) {
		...
		CubeRotationAnimation l=new CubeRotationAnimation();

		glcanvas.setSize(800, 600);

		final JFrame frame = new JFrame ("Cube-Rotation-Animation");
